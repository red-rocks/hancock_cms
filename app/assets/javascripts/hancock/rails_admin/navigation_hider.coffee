...
$(document).on 'click', ".toggle-sidebar", (e)->
  ...
  if sidebar.hasClass("shorted")
    # navigation_filter_input.data("value", navigation_filter_input.val()).val("").closest(".navigation-filter")
    navigation_filter_input.data("value", navigation_filter_input.val()).val("").closest(".navigation-filter").hide()
  else
    # navigation_filter_input.val(navigation_filter_input.data("value")).closest(".navigation-filter")
